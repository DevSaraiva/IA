...
aresta(real/rua-dos-palois,palmeira/rua-do-rio,8.5).
...
aresta(real/rua-dos-palois,real/rua-do-tojal,0.4).
aresta(real/rua-das-giestas,real/rua-do-tojal,0.3).
aresta(real/rua-das-giestas,real/rua-dos-palois,0.35).
