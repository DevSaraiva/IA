...
+encomenda(Id, _, _, _, _, _, _, _)::((findall(Id,(encomenda(Id, _, _, _, _, _, _, _)),Sol), length(Sol,N), N < 2).
...
encomenda(telemovel, margarida, pedro, vila-caiz/aldeia-nova, data(2021, 3, 10)/data(2021, 3, 9), 2, 3/10, 3).
